...
- **Health (last full check):** `typecheck` ✓ · **283/283** unit ✓ · `build` ✓ (~178 KB gzip) · **15/15** e2e ✓ · no conflict markers / code smells.
