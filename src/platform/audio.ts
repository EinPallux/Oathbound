...
// A placeholder until the dedicated audio pass (0.7.x); satisfies "every ability has
// audible feedback" at a basic level. Degrades silently where audio is unavailable.
